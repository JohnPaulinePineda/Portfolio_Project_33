...
##################################
Oscars.MCA <- Oscars[,c("Genre",
                       "Picture",
                       "Cinematography",
                       "Editing",
                       "Screenplay")]

(Oscars.MCA.Picture <- as.data.frame.matrix(
  table(Oscars.MCA$Genre,Oscars.MCA$Picture)))
colnames(Oscars.MCA.Picture) <- c("Picture_NOM",
                                 "Picture_WON")
Oscars.MCA.Picture$Film <- rownames(Oscars.MCA.Picture)
Oscars.MCA.Picture <- Oscars.MCA.Picture[,c(3,1,2)]

(Oscars.MCA.Cinematography <- as.data.frame.matrix(
  table(Oscars.MCA$Genre,Oscars.MCA$Cinematography)))
colnames(Oscars.MCA.Cinematography) <- c("Cinematography_NNOM",
                                        "Cinematography_NOM",
                                        "Cinematography_WON")
Oscars.MCA.Cinematography$Film <- rownames(Oscars.MCA.Cinematography)

(Oscars.MCA.Editing <- as.data.frame.matrix(
  table(Oscars.MCA$Genre,Oscars.MCA$Editing)))
colnames(Oscars.MCA.Editing) <- c("Editing_NNOM",
                                 "Editing_NOM",
                                 "Editing_WON")
Oscars.MCA.Editing$Film <- rownames(Oscars.MCA.Editing)


(Oscars.MCA.Screenplay <- as.data.frame.matrix(
  table(Oscars.MCA$Genre,Oscars.MCA$Screenplay)))
colnames(Oscars.MCA.Screenplay) <- c("Screenplay_NNOM",
                                    "Screenplay_NOM",
                                    "Screenplay_WON")
Oscars.MCA.Screenplay$Film <- rownames(Oscars.MCA.Screenplay)

Oscars.MCA <- left_join(Oscars.MCA.Picture,Oscars.MCA.Cinematography)
Oscars.MCA <- left_join(Oscars.MCA,Oscars.MCA.Editing)
Oscars.MCA <- left_join(Oscars.MCA,Oscars.MCA.Cinematography)
(Oscars.MCA <- left_join(Oscars.MCA,Oscars.MCA.Screenplay))
dim(Oscars.MCA)
str(Oscars.MCA)
summary(Oscars.MCA)
...
(DR_PCA_VarianceScreePlot <- fviz_eig(DR_PCA, 
                                      ...
                                      ylim = c(0, 100),
                                      choice = c("variance")) +
  labs(title = "PCA : Scree Plot of Explained Variances",
...
(DR_PCA_EigenvalueScreePlot <- fviz_eig(DR_PCA, 
                                      ...
                                      ylim = c(0, 6),
                                      choice = c("eigenvalue")) +
  labs(title = "PCA : Scree Plot of Eigenvalues",
       subtitle = "Top 2 Principal Components",
       y = "Eigenvalues",
       x = "Principal Components") +
  theme_classic())
...
(DR_CA_Cinematography_VarianceScreePlot <- fviz_eig(DR_CA_Cinematography, 
                                                    ...
                                                    ylim = c(0, 100),
                                                    choice = c("variance")) +
  labs(title = "CA : Scree Plot of Explained Variances",
       subtitle = "Top 2 Principal Components",
       y = "Percentage of Explained Variances",
       x = "Principal Components") +
  theme_classic())
...
(DR_CA_Cinematography_EigenvalueScreePlot <- fviz_eig(DR_CA_Cinematography, 
                                                      ...
                                                      ylim = c(0, 6),
                                                      choice = c("eigenvalue")) +
  labs(title = "CA : Scree Plot of Eigenvalues",
       subtitle = "Top 2 Principal Components",
       y = "Eigenvalues",
       x = "Principal Components") +
  theme_classic())
...
(DR_CA_Cinematography_ROW_PCVariableContributors <- fviz_contrib(DR_CA_Cinematography, 
                                                             choice = "row", 
                                                             axes = 1:2) +
  labs(title = "CA : Row Descriptor Variable Contribution",
       subtitle = "Principal Components 1 and 2 Contributors",
       x = "Descriptors") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90,hjust = 1)))
...
(DR_CA_Cinematography_COL_PCVariableContributors <- fviz_contrib(DR_CA_Cinematography, 
                                                             choice = "col", 
                                                             axes = 1:2) +
  labs(title = "CA : Column Descriptor Variable Contribution",
       subtitle = "Principal Components 1 and 2 Contributors",
       x = "Descriptors") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90,hjust = 1)))
...
(DR_CA_Cinematography_COL_PC2VariableContributors <- fviz_contrib(DR_CA_Cinematography, 
                                                             choice = "col", 
                                                             axes = 2) +
  labs(title = "CA : Col Descriptor Variable Contribution",
       subtitle = "Principal Component 2 Contributors",
       x = "Descriptors") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90,hjust = 1)))
...
(DR_CA_SymmetricBiplot <- fviz_ca_biplot(DR_CA_Cinematography, 
              ...
              geom = "text",
              repel = TRUE) +
  labs(title = "CA : Symmetric Biplot",
...
(DR_CA_SymmetricBiplot <- fviz_ca_biplot(DR_CA_Cinematography, 
              ...
              repel = TRUE,
              map = "symbiplot") +
  labs(title = "CA : Asymmetric Biplot",
       subtitle = "Row versus Column Descriptor Variable Loadings",
       x = "Principal Component 1",
       y = "Principal Component 2") +
  theme_classic())
