...
(DR_PCA_VariableCorrelationCircle <- fviz_pca_var(DR_PCA, 
  ...
  labs(title = "Principal Component Analysis : Factorial Map of Quantitative Variables",
...
(DR_MCA_VariableCorrelationCircle <- fviz_mca_var(DR_MCA, 
                                         ...
                                         palette = c("#0073C2FF", "#EFC000FF", "#868686FF"),
                                         legend.title = "Cluster") +
  labs(title = "Multiple Correspondence Analysis : Correlation Chart",
       subtitle = "Principal Components Versus Descriptor Variable Clusters",
       y = "Principal Component 2",
       x = "Principal Component 1") +
  theme_classic() +
...
(DR_FAMD_VariableCorrelationCircle <- fviz_famd_var(DR_FAMD, 
                                         ...
                                         palette = c("#0073C2FF", 
                                                     "#EFC000FF"),
                                         legend.title = "Cluster") +
  labs(title = "Factor Analysis of Mixed Data : Factorial Map of Variables",
       subtitle = "Principal Components Versus Descriptor Variable Clusters",
       y = "Principal Component 2",
       x = "Principal Component 1") +
  theme_classic() +
