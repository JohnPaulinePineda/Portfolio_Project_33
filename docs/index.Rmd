...
|
```{r section_1.5.1, warning=TRUE, message=TRUE}
##################################
# Loading dataset
##################################
SD_PCA <- Oscars.PCA
...
##################################
(DR_PCA_ScreePlot <- fviz_eig(DR_PCA, addlabels = TRUE, ylim = c(0, 100)) +
...
##################################
(DR_PCA_CorrelationCircle <- fviz_pca_var(DR_PCA, 
                                         col.var = DR_PCA_KMEANS_CLUSTER, 
                                         palette = c("#0073C2FF", "#EFC000FF", "#868686FF"),
                                         legend.title = "Cluster") +
  labs(title = "PCA : Correlation Circle",
       subtitle = "Principal Components Versus Predictor Clusters",
...
# for the Top 2 principal components
##################################
(DR_PCA_PC1Contributors <- fviz_contrib(DR_PCA, 
                                 choice = "var", 
                                 axes = 1) +
  labs(title = "PCA : Variable Contribution",
       subtitle = "Principal Component 1 Contributors",
       x = "Descriptors") +
  theme_classic() +
  theme(axis.text.x = element_text(angle = 90,hjust = 1)))

(DR_PCA_PC2Contributors <- fviz_contrib(DR_PCA, 
                                 choice = "var", 
                                 axes = 2) +
  labs(title = "PCA : Variable Contribution",
...
##################################
# Gathering all PCA plots
##################################
grid.arrange(DR_PCA_ScreePlot, 
             DR_PCA_CorrelationCircle, 
             DR_PCA_PC1Contributors, 
             DR_PCA_PC2Contributors, 
             ncol = 2)
...
(fviz_pca_ind(DR_PCA,
  ...
  labs(title = "PCA : Correlation Circle",
       subtitle = "Principal Components Versus Individuals",
       y = "Principal Component 2",
       x = "Principal Component 1") +
  theme_classic() +
  theme(legend.position="top"))
