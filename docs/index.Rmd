...
| 
| **[B]** With eigenvalues sufficiently greater than 1, only <span style="color: #FF0000">PC1</span> and <span style="color: #FF0000">PC2</span> will be used in the subsequent exploratory analysis.
|      **[B.1]** <span style="color: #FF0000">PC1</span> = 2.22
|      **[B.1]** <span style="color: #FF0000">PC2</span> = 1.67
|
| **[C]** <span style="color: #FF0000">PC1</span> can be characterized by the following descriptor variables, ranked based on contribution and statistical significance:
...
| 
| **[D]** <span style="color: #FF0000">PC2</span> can be characterized by the following descriptor variables, ranked based on importance and statistical significance:
