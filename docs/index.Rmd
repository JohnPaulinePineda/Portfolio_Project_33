...
##################################
Oscars.FAMD <- Oscars[,c("Tomatometer_Critic",
                        "Tomatometer_Audience",
                        "IMDB_Critic",
                        "IMDB_Audience",
                        "Nominations_Total",
...
# from quantitative descriptor variables
# on the factor map 
##################################
(DR_MFA_QuantitativeIndividualGroups <- fviz_mfa_ind(DR_MFA, 
                                       partial = "all",
                                       geom = "text",
                                       repel = TRUE,
                                       habillage = SD_MFA$Picture, 
                                       palette = c("#888888","#5544FF")) +
  labs(title = "Multiple Factor Analysis : Individuals for Quantitative Variable Groups",
       subtitle = "Descriptor Variable Principal Components",
       y = "Principal Component 2",
       x = "Principal Component 1") +
  theme_classic() +
...
# on the factor map 
##################################
# (DR_MFA_QualitativeIndividualGroups <- fviz_mfa_quali_biplot(DR_MFA, 
#                                        geom = "text") +
