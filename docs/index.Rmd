...
# among numeric descriptors
# grouped by Picture
##################################
splom(~DE_Oscars[,c(3:10)],
      groups = DE_Oscars$Picture,
      pch = 16,
      cex = 1,
      alpha = 0.45,
      ...
      main = "Exploratory Analysis Between Picture and Numeric Predictors",
      xlab = "Scatterplot Matrix of Numeric Predictors")
...
splom(~DE_Oscars[,c(3:10)],
      ...
      varnames = c("T_CTC", "T_AUD", "T_GAP",
                  ...
                  "NOM", "WIN%"),
      auto.key = list(points = TRUE, space = "right"),
      main = "Exploratory Analysis Between Year and Numeric Predictors",
      xlab = "Scatterplot Matrix of Numeric Predictors")
