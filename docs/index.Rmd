...
| 
| **[D]** <span style="color: #FF0000">PC2</span> can be described as having high critic scores but low audience scores and oscar wins, or having low critic scores but high audience scores and oscar wins, as characterized by the following descriptor variables, ranked based on importance and statistical significance:
...
|      **[E.2]** 3 clusters were formulated based on the correlations between descriptor variables:
|             **[E.2.1]** Cluster 1 : <span style="color: #FF0000">IMDB_Critic</span>) and <span style="color: #FF0000">Tomatometer_Critic</span>) indicating that critic scores are consistent for both sources (Tomatometer and IMDB)
|             **[E.2.2]** Cluster 2 : <span style="color: #FF0000">IMDB_Audience</span>), <span style="color: #FF0000">Tomatometer_Audience</span>) and <span style="color: #FF0000">Nomination_SuccessRate</span>) indicating that audience scores are consistent for both sources (Tomatometer and IMDB), and are correlated with oscar wins.
|             **[E.2.3]** Cluster 3 : <span style="color: #FF0000">Nominations_Total</span>) indicating that the number of oscar nominations are not correlated with critic and audience scores, as well as oscar wins.
| 
